    ...
    <div className="w-full max-w-md mx-auto px-6 py-16 md:py-24">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-[#E8DED0]">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-serif text-[#1F2937] mb-2 font-bold">Create Account</h2>
          <p className="text-[#4F4F4F] text-sm">Create an account to get started.</p>
        </div>

        <form onSubmit={handleSignUp} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-[#1F2937] mb-1.5" htmlFor="fullName">
              Full Name
            </label>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#A09080]" />
              <input
                id="fullName"
                type="text"
                required
